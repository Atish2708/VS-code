...
def application():
    ...
    st.set_page_config(page_title="Loan Calulator by Atish")
    # show application title
    st.title("Loan Calculator by Atish")
    #Add the subheading
    st.subheader("please provide the loan details")
    #Get Principle,Period and Rate of interest as input
    P=st.number_input("Principle (INR) :",min_value=0.00,step=0.01)
